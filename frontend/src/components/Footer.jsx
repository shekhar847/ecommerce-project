...
function Footer() {
  return (
    <footer className="footer mt-5 pt-5 pb-4 border-top border-light" style={{ background: "#ffffff" }}>
      <div className="container">
        <div className="row g-4 mb-4">
          {/* Brand Col */}
          <div className="col-lg-4 text-start">
            <div className="d-flex align-items-center gap-2 mb-3">
              <div className="rounded-circle d-flex align-items-center justify-content-center" style={{ width: "32px", height: "32px", background: "#0f172a" }}>
                <SparklesIcon size={18} className="text-white" />
              </div>
              <h4 className="fw-bold mb-0 text-dark" style={{ fontFamily: "var(--font-display)", fontWeight: "800" }}>
                ShopSphere
              </h4>
            </div>
          ...
          {/* Categories */}
          <div className="col-lg-3 col-6 text-start">
            <h6 className="fw-bold text-dark mb-3">Popular Categories</h6>
            <ul className="list-unstyled text-secondary small d-flex flex-column gap-2">
          ...
          <div className="col-lg-2 text-start">
            <h6 className="fw-bold text-dark mb-3">Guarantees</h6>
        ...
        <div className="border-top border-light pt-3 mt-4 text-center">
